...
export const ExerciseBox = ({
  ...
  return (
    <div className={`
      ...
      pb-1 pt-2
    `}>
      <div className="flex flex-row items-center  mr-6 text-xl hover:bg-gray-400 hover:bg-opacity-25">
        <img className ="rounded-lg mx-2 " src={urlImageIntroduce} alt={'alt'} width={70} height={70}/>
      ...
      <a className="rounded-lg relative mx-2 flex flex-col" href="/barbell/male/anterior-deltoid/barbell-bench-press/">
        {showVideo && (
          <video 
            ...
            loop={true}
            src={urlVideo}
            className="rounded-lg lazy  rounded-t-none mx-2 my-1">
          </video> 
        )} 
      </a>
